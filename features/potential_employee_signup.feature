Feature: Sign up new potential employees from kiosk form
  ...
  Scenario: Successfull Employee Signup
    ...
    When I fill in "Last name" with "Employee"
      ...
      And I fill in "Date of birth" with "01011977"
    ...
    When I choose "Yes" within "Are there any days, shifts, or hours you will not work?"
      ...
      And I choose "Yes" within "Do you have reliable transportation?"
      And I choose "Yes" within "Can you travel long term?"
      And I choose "Yes" within "Have you ever been convicted of a crime?"
      And I fill in "ever_convicted_conditions" with "Grand Theft Auto"
      And I choose "No" within "Have you ever failed a drug test?"
      And I choose "Yes" within "Are you legally authorized to work in the United States?"
      And I choose "Yes" within "Have you ever applied for work or worked here before?"
      And I fill in "If yes, when and reason not employed currently?" with "Laid off"
      And I choose "Yes" within "Do you have a valid Driver's License?"
      And I select "Alabama" from "License State"
      And I fill in "License number" with "55-5555-55555"
      And I fill in "Expiration date" with "01012011"
      And I choose "Yes" within "Has your Drivers License ever been suspended?"
      And I fill in "drivers_license_ever_suspended_conditions" with "Unpaid tickets"
      And I press "Next"
