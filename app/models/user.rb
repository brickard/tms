...
class User < ActiveRecord::Base
  ...
  has_many :accidents, :foreign_key => :employee_id
  has_many :accidents_supervised, :foreign_key => :supervisor_id
  has_many :incidents, :foreign_key => :employee_id
  has_many :incidents_supervised, :foreign_key => :supervisor_id
  belongs_to :shift
